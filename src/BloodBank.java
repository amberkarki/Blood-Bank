...
public class BloodBank {
	...
	public void startProgram()
	{
		...
		while (true)
		{
			...
			{
				System.out.print("Thank you for using the service. Please vist again!");
				break;
			}
		}
	}
	...
	private void printBloodInfo()
	{
		...
		for (String key : each_blood_group_count) {
		    System.out.println("   \n"+key+ "    |     " + Collections.frequency(blood_type_string, key)+" packets");
		    System.out.println("----------------------------");
		}
	}
	...
	private void takeBlood()
	{
		...
		if(counter == 0)
		{
			System.out.println("Blood Bank lacks "+user_input+" blood!");
		}
	}
